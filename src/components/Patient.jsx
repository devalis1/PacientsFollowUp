const Patient = ({patientInfo, setPatient, deletePatient}) => {
  const {petName, ownerName, email, date, synthoms, id} = patientInfo;
  const handleDelete = () => {
    const confirmation = confirm("Are you sure you want to delete the patient?")
    if(confirmation) {
      deletePatient(id);
    }
  }
    ...
    <div className="mx-5 my-5 bg-white shadow-md px-5 py-10 rounded-xl">
        ...
        <div className="flex justify-between mt-10">
          <button 
            ...
            onClick={() => setPatient(patientInfo)}
          >
            Edit
          </button>
